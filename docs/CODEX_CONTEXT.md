...
- `2026年度核心假设` 已建设为 `01_基石文件` 的核心假设层文件。
- `2026年度核心假设` 用于统一 Rachel Capital OS 在 2026 年的全球宏观、中国宏观、AI革命、七大战略生态、A股 / 港股 / 美股、一级市场、估值和风险控制的年度研究假设。
- `2026年度核心假设` 通过七大战略生态季度跟踪表、公司池、公司数据库、估值引擎和投资决策引擎进行验证。
- `2026年度核心假设` 不是预测承诺，不构成交易依据、定价判断或回报承诺。
- 如果季度跟踪数据连续两个季度与年度核心假设冲突，需要更新基石文件更新日志。
- 基石文件用于支撑七大战略生态、公司数据库、估值引擎、投资决策引擎和工作流。
- 所有基石文件均为内部研究内容，frontmatter 应保持 `public: false`。
- 所有世界观层文件仅用于内部研究，不构成交易依据、定价判断或回报承诺。
- 后续待建设：Rachel产业研究方法论、Rachel组合构建原则。
- 后续建议继续建设：Rachel组合构建原则、不投资清单、高置信度机会判断标准、十倍股判断框架。
...
- 后续 Web Platform 可增加“基石文件 / 年度核心假设”页面；七大战略生态季度跟踪表后续应验证 `2026年度核心假设`。
