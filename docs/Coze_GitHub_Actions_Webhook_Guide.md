...
```text
每周一至周六北京时间 07:30 启动科技动向日报生成任务，目标是在 08:30 前完成 Web Platform 发布。周日不生成日报。
