...
## 2026-06-26 半导体生态 1.0 更新记录

半导体生态已从 Seed 0.1 升级为 1.0 样板生态之一，并与“中国关键技术攻关长期跟踪”专题建立双向链接。

本次公开站同步内容：

- 首页“七大战略生态”中的半导体生态摘要已更新。
- “战略生态”页面中的半导体生态卡片摘要已更新。
- 半导体生态详情页已展示 1.0 内容。
- 详情页新增展示“子链条拆解”和“Coze 日报自动关联规则”两个公开结构化章节。
- 详情页仍隐藏“公开展示摘要”，该内容仅用于首页和卡片摘要。
...
- `02_战略生态/半导体生态.md` 升级为 1.0。
- `02_战略生态/半导体生态/` 新增半导体设备、半导体材料、先进封装、第三代半导体、公司池、指标和 Coze 规则等子文件。
- `06_投资主题/中国关键技术攻关长期跟踪/七大战略生态映射.md` 增加半导体生态子链条链接。
- `06_投资主题/中国关键技术攻关长期跟踪/中国关键技术攻关全景报告.md` 增加半导体生态内部链接。

本地验收结果：

- `python3 scripts/export_public_site.py` 导出成功。
- `public_site/data/ecosystems.json` 包含 7 个战略生态。
- 半导体生态公开摘要已更新为 1.0 版本。
- 半导体生态详情页章节编号连续，无 404。
- 半导体子目录文件均为内部工作文件，未作为独立公开页面导出。
- 本阶段未合并 main，未发布 GitHub Pages。
